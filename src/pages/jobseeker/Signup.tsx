...
export default function JobSeekerSignup() {
  ...
  const onSubmit = async (data: SignupFormData) => {
    try {
      // const response = await fetch('http://127.0.0.1:8000/api/v1/auth/signup/job-seeker', {
      //   method: 'POST',
      //   headers: {
      ...
      const response = await fetch('http://localhost:8000/api/v1/auth/signup/job-seeker', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{' '}
          <Link to="/jobseeker/login" className="font-medium text-primary-600 hover:text-primary-500">
